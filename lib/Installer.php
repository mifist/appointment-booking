...
class Installer extends Base\Installer
{
    ...
    public function __construct()
    {
        ...
        $this->options = array(
            ...
            'bookly_l10n_label_category'                 => __( 'Sub Category', 'bookly' ),
            'bookly_l10n_label_rank'                    => __( 'Category', 'bookly' ),
            ...
            'bookly_l10n_option_category'                => __( 'Select sub category', 'bookly' ),
            'bookly_l10n_option_rank'                    => __( 'Select category', 'bookly' ),
