 ...
 * @method static array  prepareUpdateCategoryResponse( array $response, \Bookly\Lib\Entities\Category $category, array $_post ) Prepare response for updated service.
 ...
 * @method static array  categoryCreated( \Bookly\Lib\Entities\Category $category, array $_post ) Category created
 ...
 * @method static array  updateCategory( array $alert, \Bookly\Lib\Entities\Category $category, array $_post ) Update service settings in add-ons
 ...
 * @method static void   renderCategoryForm( array $category ) Render content in service form
 * @method static void   renderServiceFormHead( array $service ) Render top content in service form
 * @method static void   renderCategoryFormHead( array $category ) Render top content in service form
 ...
 * @method static void   renderStaffService( int $staff_id, int $service_id, int $rank_id, array $services_data ) Render controls for Staff on tab services.
 * @method static void   renderStaffServices( int $staff_id ) Render Components for staff profile
 * @method static void   renderStaffServiceTail( int $staff_id, int $service_id, int $rank_id, $attributes = array() ) Render controls for Staff on tab services.
