 ...
 * @method static \BooklyServiceExtras\Lib\Entities\ServiceExtra[] findByCategoryId( int $category_id ) Return extras
 * entities.
 * @see \BooklyServiceExtras\Lib\ProxyProviders\Local::findByCategoryId()
 *
