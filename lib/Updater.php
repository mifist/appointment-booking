...
class Updater extends Base\Updater
{
    ...
    function update_11_7()
    {
        ...
        $appearance = array(
            ...
            'ab_appearance_text_label_rank'         => 'bookly_l10n_label_rank',
            ...
            'ab_appearance_text_option_rank'        => 'bookly_l10n_option_rank',
    ...
    function update_7_3()
    {
	    ...
	    $ranks = Entities\Rank::query( 'c' )->select( 'c.id, c.name' )->fetchArray();
	    foreach ( $ranks as $rank ) {
		    do_action( 'wpml_register_single_string', 'bookly', 'rank_' . $rank['id'], $rank['name'] );
	    }
    ...
    function update_7_0_1()
    {
	    ...
	    $wpdb->query(
		    'CREATE TABLE IF NOT EXISTS `' . Entities\Rank::getTableName() . '` (
                `id`       INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
                `name`     VARCHAR(255) NOT NULL,
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\Service::getTableName() . '` (
                ...
                CONSTRAINT
                 ...
                 CONSTRAINT
                    FOREIGN KEY (rank_id)
                    REFERENCES ' . Entities\Rank::getTableName() . '(id)
                    ON DELETE SET NULL
                    ON UPDATE CASCADE
            ) ENGINE = INNODB
            DEFAULT CHARACTER SET = utf8
    ...
    function update_7_0()
    {
        ...
        $ab_tables = array(
            ...
            'ab_rank'                 => Entities\Rank::getTableName(),
    ...
    function update_4_3()
    {
        ...
        $wpdb->query( 'ALTER TABLE `ab_rank` ADD `position` INT NOT NULL DEFAULT 9999;' );
    ...
    function update_2_0()
    {
        ...
        add_option( 'ab_appearance_text_label_category', __( 'Sub Category', 'bookly' ), '', 'yes' );
        add_option( 'ab_appearance_text_label_rank', __( 'Category', 'bookly' ), '', 'yes' );
        ...
        add_option( 'ab_appearance_text_option_category', __( 'Select sub category', 'bookly' ), '', 'yes' );
        add_option( 'ab_appearance_text_option_rank', __( 'Select category', 'bookly' ), '', 'yes' );
