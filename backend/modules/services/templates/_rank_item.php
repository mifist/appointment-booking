...
<li class="bookly-nav-item bookly-rank-item" data-rank-id="<?php echo $rank['id'] ?>">
    <div class="bookly-flexbox">
        ...
        <div class="bookly-flex-cell bookly-vertical-middle">
            <span class="displayed-value"><?php echo esc_html( $rank['name'] ) ?></span>
            <input class="form-control input-lg" type="text" name="name" value="<?php echo esc_attr( $rank['name'] ) ?>" style="display: none"/>
        </div>
        <div class="bookly-flex-cell bookly-vertical-middle" style="width: 1%">
